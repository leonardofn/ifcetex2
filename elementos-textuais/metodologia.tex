...
Almejando a credibilidade junto à comunidade científica nacional e internacional, um grupo de servidores, composto por docentes e bibliotecários, elaborou o Manual de Normalização de Trabalhos Acadêmicos que servirá de orientação à comunidade do IFCE no que diz respeito à utilização das normas para elaboração e apresentação gráfica de trabalhos acadêmicos \cite[p.~1]{ifcemanual2018}.
